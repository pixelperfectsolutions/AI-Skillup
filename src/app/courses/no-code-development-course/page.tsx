...
export default function NoCodeCourse() {
    return (
        <>
            <HeroSub
                title='No-Code Development Course'
                subtitle='Build real-world apps without code using Bubble, Webflow, Glide, and powerful AI automation tools.'
                breadcrumbs={[
                    { label: 'Courses', href: '/courses' },
                    { label: 'No-Code Development Course' }
                ]}
            />
                        ...
                        <div className='lg:sticky lg:top-24'>
                            ...
                            <div className='mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4'>
                                <div className='bg-primary/5 p-6 rounded-2xl border border-primary/10'>
                                    ...
                                    <p className='text-lg font-bold text-gray-900'>3 Months | 1 month course</p>
                                </div>
                        ...
                        <div className='flex flex-col gap-10'>
                                    ...
                                    {[
                                        ...
                                        <div key={idx} className='group flex items-center gap-4 bg-gray-900 p-6 rounded-2xl text-white hover:bg-primary transition-all duration-300 shadow-xl'>
                                            <div className='bg-white/10 p-3 rounded-xl group-hover:scale-110 transition-transform'>
                                                <Icon icon="solar:widget-add-bold" width={24} />
                                            </div>
                            ...
                            <div>
                                ...
                                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                                    {[
                                        { title: "Visual Frontends", desc: "Building responsive web pages using Webflow and Bubble's drag-and-drop." },
                                        { title: "Database Logic", desc: "Setting up data structures, privacy rules, and workflows without code." },
                                        { title: "API Integrations", desc: "Connecting your app to OpenAI, Stripe, and SendGrid using API connectors." },
                                        { title: "Automation & Scaling", desc: "Building complex business logic and background tasks with AI automation." }
                                    ].map((module, idx) => (
