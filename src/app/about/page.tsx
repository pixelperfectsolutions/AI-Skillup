            ...
            <section className="py-24 bg-white">
                <div className="container">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
                        {/* Text */}
                        <div>
                            <h6 className="inline-block px-5 py-2 rounded-full mb-5 bg-primary/10 text-primary border border-primary/20">
                                About AI SKILL UP
                            </h6>
                            <h2 className="mb-6">
                                Who We Are
            ...
            <section className="py-16 bg-white">
                <div className="container">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        {stats.map((s, i) => (
                            <div key={i} className="text-center rounded-3xl py-10 px-6 transition-all duration-300 hover:-translate-y-1 bg-white border border-gray-100 shadow-sm">
                                <h3 className="mb-1 text-primary">
                                    {s.value}
                                </h3>
                                <h6 className="text-gray-400">{s.label}</h6>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className="py-20 bg-white">
                <div className="container">
                    <div className="text-center mb-14">
                        ...
                        <h5 className="text-primary uppercase tracking-widest">of AI SkillUp</h5>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                        {whyChoose.map((item, i) => (
                            <div key={i} className="rounded-3xl p-8 text-center transition-all duration-300 hover:-translate-y-2 bg-white border border-gray-100 shadow-sm">
                        ...
                        {team.map((member, i) => (
                            <div key={i}
                                ...
                                <div className="p-5 bg-white">
                                    ...
                                    <h6 className="text-primary">{member.title}</h6>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <section className="py-20 bg-white">
                <div className="container">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
                        {values.map((v, i) => (
                            <div key={i}
                                className="rounded-3xl p-7 text-center transition-all duration-300 hover:-translate-y-2 bg-white border border-gray-100 shadow-sm">
