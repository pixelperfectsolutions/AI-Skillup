...
export const HeaderData: HeaderType[] = [
  ...
  { label: 'About', href: '/about' },
  {
    ...
    href: '/courses',
    submenu: [
      { label: 'Python Programming Course in Coimbatore', href: '/courses/python-course-coimbatore' },
      { label: 'Data Science Course in Coimbatore', href: '/courses/data-science-course-coimbatore' },
      { label: 'Full-Stack Development Course in Coimbatore', href: '/courses/full-stack-development-course-coimbatore' },
      { label: 'UI & UX Design Course in Coimbatore', href: '/courses/ui-ux-design-course-coimbatore' },
      { label: 'Mobile App Development Course in Coimbatore', href: '/courses/mobile-app-development-course-coimbatore' },
      { label: 'No-Code AI Automation Course in Coimbatore', href: '/courses/no-code-ai-automation-coimbatore' },
      { label: 'Digital Marketing Course in Coimbatore', href: '/courses/digital-marketing-course-coimbatore' },
    ]
  },
...
export const TechGaintsData: { imgSrc: string }[] = [
...
export const CourseData: CourseType[] = [
  {
    heading: 'Python Programming Course in Coimbatore',
    name: 'Python Expert',
  ...
  },
  {
    ...
    name: 'Data Scientist',
    imgSrc: '/images/courses/data-science.png',
    students: 130,
    classes: 12,
    price: 20,
    rating: 5.0,
  ...
  },
  {
    ...
    name: 'James Nolan',
    imgSrc: '/images/courses/fullstack.png',
    students: 150,
    classes: 12,
    price: 20,
    rating: 5.0,
  ...
  },
  {
    ...
    name: 'Elena Brooks',
    imgSrc: '/images/courses/uiux.png',
    students: 130,
    classes: 12,
    price: 20,
    rating: 5.0,
  ...
  },
  {
    ...
    name: 'Aria Kim',
    imgSrc: '/images/courses/mobile-app.png',
    students: 120,
    classes: 12,
    price: 20,
    rating: 5.0,
  ...
  },
  {
    ...
    name: 'Marcus Lee',
    imgSrc: '/images/courses/nocode.png',
    students: 180,
    classes: 12,
    price: 20,
    rating: 5.0,
  ...
  },
  {
    ...
    name: 'Sophia Patel',
    imgSrc: '/images/courses/digital-marketing.png',
    students: 200,
    classes: 12,
    price: 20,
    rating: 5.0,
